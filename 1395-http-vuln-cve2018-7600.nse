...
-- |     Risk factor: High  CVSSv3: 9.8 (High) (CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H)
...
-- </table>
-- <table key='scores'>
-- <elem key='CVSSv3'>9.8 (HIGH) (CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H)</elem>
-- </table>
...
action = function(host, port)
  local vuln_table = {
    ...
    risk_factor = 'High',
    scores = {
      CVSSv3 = '9.8 (HIGH) (CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H)',
    },
    description = [[
Remote code execution vulnerability within multiple subsystems of Drupal 7.x and 8.x.
]],
